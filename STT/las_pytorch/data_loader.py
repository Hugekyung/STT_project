...
if __name__ == "__main__":
    wav_file = load_audio(r'D:\git\ClovaCall\data\ClovaCall\wavs_test\41_0514_301_0_07111_00.wav')
    pcm_file = load_audio(r'D:\Downloads\KsponSpeech_01\KsponSpeech_0001\KsponSpeech_000001.pcm')
    print(len(wav_file), len(pcm_file))